	...
	.file	"asm-offsets.c"
@ GNU C (Hisilicon_v500_20160223) version 4.9.4 20150629 (prerelease) (arm-hisiv500-linux-uclibcgnueabi)
@	compiled by GNU C version 4.1.2 20080704 (Red Hat 4.1.2-44), GMP version 5.1.3, MPFR version 3.1.2, MPC version 1.0.2
...
@ -iprefix /opt/hisi-linux/x86-arm/arm-hisiv500-linux/bin/../lib/gcc/arm-hisiv500-linux-uclibcgnueabi/4.9.4/
@ -isysroot /opt/hisi-linux/x86-arm/arm-hisiv500-linux/bin/../target
@ -D __KERNEL__ -D __LINUX_ARM_ARCH__=7 -U arm -D CC_HAVE_ASM_GOTO
@ -D KBUILD_STR(s)=#s -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
@ -isystem /opt/hisi-linux/x86-arm/arm-hisiv500-linux/bin/../lib/gcc/arm-hisiv500-linux-uclibcgnueabi/4.9.4/include
...
@ -marm -mlittle-endian -mlra -mpic-data-is-text-relative -msched-prolog
@ -muclibc -munaligned-access -mvectorize-with-neon-quad
...
->TSK_ACTIVE_MM #440 offsetof(struct task_struct, active_mm)	@
@ 0 "" 2
